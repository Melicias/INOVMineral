...
df_train = pd.read_csv('../../../../data/datasetIot23/IoT-23_train_smote.csv', low_memory=False)
...
y_train = df_train["type"].values[train_indices]
y_train = le.transform(y_train)

X_valid = df_train[features].values[valid_indices]
y_valid = df_train["type"].values[valid_indices]
...
met.calculate_metrics("XGBoost multiclass normal", y_test, predictions, average='weighted')
